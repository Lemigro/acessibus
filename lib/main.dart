...
class _AcessibusAppState extends State<AcessibusApp> {
  ...
  Widget build(BuildContext context) {
    ...
    final lightTheme = ThemeData(
        ...
        surface: altoContraste ? (altoContrasteSurface ?? Colors.grey[900]!) : Colors.white,
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          foregroundColor: altoContraste ? altoContrasteOnPrimary : Colors.white,
    ...
    final darkThemeData = ThemeData(
      colorScheme: ColorScheme.dark(
        ...
        secondary: altoContraste ? altoContrastePrimary : const Color(0xFF81C784),
        onSecondary: altoContraste ? altoContrasteOnPrimary : Colors.black,
        surface: darkSurface,
        onSurface: darkText,
        background: darkBackground,
        onBackground: darkText,
        error: altoContraste ? (Colors.red[700] ?? Colors.red) : (Colors.red[400] ?? Colors.red),
        onError: Colors.white,
        surfaceVariant: altoContraste ? (Colors.grey[800] ?? Colors.grey) : const Color(0xFF2C2C2C),
        onSurfaceVariant: darkTextSecondary,
      ),
      scaffoldBackgroundColor: darkBackground,
      useMaterial3: false,
      cardColor: darkSurface,
      dividerColor: altoContraste ? altoContrasteBorder : Colors.white.withOpacity(0.12),
      inputDecorationTheme: InputDecorationTheme(
        filled: true,
        ...
        border: OutlineInputBorder(
          borderRadius: BorderRadius.circular(12),
          borderSide: BorderSide(
            color: altoContraste ? altoContrasteBorder : Colors.white.withOpacity(0.23),
            width: altoContraste ? 2 : 1,
          ),
          ),
          enabledBorder: OutlineInputBorder(
